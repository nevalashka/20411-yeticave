...
<form class="form container <?= (isset($errors)) ? 'form--invalid' : '';?>" action="sign-up.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__item <?= (isset($errors['contact'])) ? 'form__item--invalid' : '';?>">
        ...
        <textarea id="message" name="contact" placeholder="Напишите как с вами связаться" required></textarea>
        <span class="form__error">Напишите как с вами связаться</span>
    </div>
    <div class="form__item form__item--file form__item--last <?= (isset($errors['url_picture'])) ? 'form__item--invalid' : '';?>">
        <label>Аватар</label>
        <div class="preview">
